...
import com.dct.survey.taishans.utils.PictureSelector.anim.OptAnimationLoader;
...
import com.dct.survey.taishans.utils.PictureSelector.tools.ToolbarUtil;
import com.dct.survey.taishans.utils.PictureSelector.tools.VoiceUtils;
import com.dct.survey.taishans.utils.PictureSelector.widget.PreviewViewPager;
import com.dct.survey.taishans.utils.photoview.OnViewTapListener;
import com.dct.survey.taishans.utils.photoview.PhotoView;
        ...
        if (id == R.id.id_ll_ok) {
            ...
            if (minSelectNum > 0) {
                if (size < minSelectNum && selectionMode == PictureConfig.MULTIPLE) {
                    ...
                    String str = eqImg ? getResources().getString(R.string.picture_min_img_num, minSelectNum)
                            : getResources().getString(R.string.picture_min_video_num, minSelectNum);
                    showToast(str);
                    return;
                }
            }
