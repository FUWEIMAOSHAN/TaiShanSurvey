package com.dct.survey.taishans.ui;
...
import com.dct.survey.taishans.http.RetrofitHttp;
import com.dct.survey.taishans.utils.Md5Util;
import com.dct.survey.taishans.utils.NetUtil;
import com.dct.survey.taishans.utils.SpUtil;
import com.dct.survey.taishans.utils.ToastUtil;
import com.dct.survey.taishans.view.PowerfulEditText;
import com.dct.survey.taishans.view.loadingdialog.LoadingDialog;
...
public class LoginActivity extends BaseActivity {
                    ...
                    .subscribe(new DefaultObserver<LoginBean>() {
                        ...
                        public void onNext(@NonNull LoginBean loginBean) {
                            ...
                            if (isTrue){
                                ...
                                if (null != currentUser) SpUtil.putString(LoginActivity.this, "guid", currentUser.getGUID());
    ...
    private void getDictionary() {
        if (!NetUtil.isConnected(this)){
            ...
            DaoManager.getInstance(LoginActivity.this).getDictionaryLibraryDao().deleteAll();
