package com.dct.survey.taishan.view.progressactivity;
...
public class ProgressRelativeLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        emptyStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressActivity_emptyContentTextColor, getResources().getColor(R.color.colorBlack));
        ...
        errorStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressActivity_errorContentTextColor, getResources().getColor(R.color.colorBlack));
        ...
        errorStateButtonBackgroundColor =
                typedArray.getColor(R.styleable.ProgressActivity_errorButtonBackgroundColor, getResources().getColor(R.color.colorBlack));
