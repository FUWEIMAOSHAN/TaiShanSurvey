package com.dct.survey.taishan.view;
 ...
 * 创建: 付威
 * 日期: 2017/3/22 16:45
 * 描述: 自定义的ClearEditText，自带清楚效果的文本输入框
 */
...
public class ClearEditText extends AppCompatEditText implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcher {
    ...
    private void init(final Context context) {
        ...
        final Drawable drawable = ContextCompat.getDrawable(context, R.drawable.icon_delete_click);
